<div class="topSection">
  ...
  <ul class="nav">
      ...
      <li><a class="hvr-underline-from-center" href="movies.php">Movies</a></li>
      ...
      <li id="cart-icon"><a class="hvr-underline-from-center" href="cart.php"><img src="images/cart-new.png" width="40px">{{numberOfItem}}</a></li>
  </ul>
</div>
